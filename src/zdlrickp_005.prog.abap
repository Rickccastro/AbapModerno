...
TABLES: zdlrick_003,zdlrick_004,zdlrick_009.
INCLUDE: zdlrickp_004.

SELECTION-SCREEN BEGIN OF BLOCK b1
  WITH FRAME TITLE TEXT-001.
  SELECT-OPTIONS: s_squad FOR zdlrick_004-id.
...
CLASS lcl_main DEFINITION CREATE PRIVATE INHERITING FROM lcl_alv.
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_alv,
             equipe              TYPE zdlrick_004-id,
             equipe_desc         TYPE zdlrick_004-descricao,
...
CLASS lcl_main IMPLEMENTATION.
  ...
  METHOD get_data.
    ...
    SELECT  z003~id,
      ...
      JOIN zdlrick_007 AS z007 ON z003~id     = z007~projeto
      JOIN zdlrick_004 AS z004 ON z003~equipe = z004~id
    ...
    IF lt_projects[] IS NOT INITIAL.
      ...
      SELECT  z007~projeto,
        ...
        FROM zdlrick_009 AS z009
        JOIN zdlrick_007 AS z007 ON z009~ticket = z007~id
